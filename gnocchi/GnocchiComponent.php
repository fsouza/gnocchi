...
class GnocchiComponent {
    ...
    /**
     * @return string name of the reflected class
     */
    ...
    /**
     * @return ReflectionClass reflected class (instance of ReflectionClass)
     */
    ...
    /**
     * @return array array containing all parameters of the constructor
     */
     ...
     *
     * @return array array containing all constructor parameters with its values ready to the class instantiation
